...
def api_dictionary(payload: DictionaryRequest, x_app_code: str | None = Header(default=None)) -> dict[str, Any]:
    ...
    return {
        ...
        "phonetic": phonetic,
        "audio": "",
        "chineseSummary": _unique_strings(summary_words, 14),
        "meanings": meanings,
